...
* How does confidence and information seeking interact in the diagnostic process? Are the quantity and quality of information seeking each related to diagnostic confidence and/or accuracy?
* Do differences in confidence and information seeking predict individual differences in accuracy?
...
```{r accVarPlot, eval=FALSE, include=FALSE, message=FALSE, echo=FALSE, warning=FALSE,out.width='100%', fig.align='center'}
...
```{r accVarSplit, include=FALSE, eval=FALSE, message=FALSE, echo=FALSE, warning=FALSE,out.width='100%', fig.align='center'}
...
```{r accVarSplit2, include=FALSE, eval=FALSE, message=FALSE, echo=FALSE, warning=FALSE,out.width='100%', fig.align='center'}
...
```{r caseClassifier, include=FALSE, eval=FALSE, message=FALSE, echo=FALSE, warning=FALSE,out.width='100%', fig.align='center'}
