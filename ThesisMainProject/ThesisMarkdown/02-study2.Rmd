...
*Figure 3.5: The average number of differentials after each stage of information seeking (x-axis, History = Patient History, Physical = Physical Examinations, Testing = Testing). The width of the blue area corresponds to the amount of data points that fall within that part of the y-axis, with a wider area meaning a higher concentration of data points. The red dots indicate the mean values, whilst the red lines indicate standard deviations.*
...
conModel <- lmer(confidenceChange ~ caseInformationProportion + initialDifferentials + absoluteDifferentialChange + (1 | condition) + (1 | id), data=studentCaseDf)

diffModel <- lmer(absoluteDifferentialChange ~ caseInformationProportion + initialDifferentials + confidenceChange + (1 | condition) + (1 | id), data=studentCaseDf)
