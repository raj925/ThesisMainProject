...
In this mixed-methods study, we aim to gain insight on the types of reasoning strategies used by medical students and how these strategies influence their information seeking patterns. We utilise a very similar experimental procedure to our previous online study (using the same patient vignettes), but instead prompted students to think out loud as they were performing the task. Everything that was said by participants were audio-recorded, transcribed and then coded for both quantitative and qualitative analysis. 
...
Results of the utterances (differential evaluations, how much they say they’re seeking information) – Desc. Quantitative
Quantitative results – by strategy
Qualitative piece – thinking aloud as they doing it
Debrief questionnaire – thematic analysis (more reflective)
Recoding analysis (from online study)

```{r stratppttable, warning=FALSE, message=FALSE}
...
```{r stratbreakdown, warning=FALSE, message=FALSE}
