...
normalityTest <- shapiro.test(filteredData$RelativeInfluence)
homoscedasticityTest <- bptest(studentAggData$proportionOfInfo ~ studentAggData$meanConfidenceOverallChange)

accTest <- lme4::glmer(Correct ~ InterraterStrat + (1|Condition) + (1|ID),family=binomial,data=TADataNoNons)
DETest <- lme4::glmer(DEs ~ InterraterStrat + (1|Condition) + (1|ID),data=TADataNoNons)
infoTest <- lme4::glmer(proportionOfInfo ~ InterraterStrat + (1|Condition) + (1|ID),data=TADataNoNons)
valTest <- lme4::glmer(infoValue ~ InterraterStrat + (1|Condition) + (1|ID),data=TADataNoNons)
conTest <- lme4::glmer(confidenceChange ~ InterraterStrat + (1|Condition) + (1|ID),data=TADataNoNons)
