...
In this mixed-methods study, we aim to gain insight on the types of reasoning strategies used by medical students and how these strategies influence their information seeking patterns. We utilise a very similar experimental procedure to our previous vignette-based study, but instead prompted students to think out loud as they were performing the task. Everything that was said by participants were audio-recorded, trascribed and then coded for both quantitative and qualitative analysis. 

Opening up differentials and not ruling out
What are the different reasoning strategies
How do we expect strategies to affect information seeking
...
```{r stratClassifier, include=TRUE, echo=FALSE, warning = FALSE, message=FALSE}
