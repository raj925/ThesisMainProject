...
\section{Vignette Information Requests and
Text}\label{vignette-information-requests-and-text}

\section{Analysis of Accuracy Using Alternative
Measures}\label{analysis-of-accuracy-using-alternative-measures}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Think Aloud Study {-} Debrief Questionnaire}

\CommentTok{\# Diagnostic Appropriateness Marking Scheme (Study 3)}

\CommentTok{\# R Environment and Packages}
\end{Highlighting}
\end{Shaded}
