...
ft <- width(ft, width = 1)
ft <- set_caption(ft,"Table S2.1: Full list of papers that were included in the systematic scoping review of papers on confidence and certainty in medical diagnses. Papers are arranged in alphabetical order. Studies marked with ** next to their title were included via citation tracking.")
